...
def gen_all_traces(
    ...
    if data_flow == 'os':
        ...
        sram_cycles, util, total_pikachu_sram, total_pikachu_array, total_pikachu_rf = \
        ...
        pikachu = total_pikachu_sram + total_pikachu_array + total_pikachu_rf
    elif data_flow == 'rs':
        sram_cycles, util, total_pikachu_sram, total_pikachu_array, total_pikachu_rf = \
    ...
    pikachu = dram.dram_trace_read_v2(
    ...
    total_pikachu_dram  = pikachu - total_pikachu_sram - total_pikachu_array - total_pikachu_rf
    for_graph_log = str(total_pikachu_dram) + "," + str(total_pikachu_sram) + "," + str(total_pikachu_array) + "," + str(total_pikachu_rf) + "\n"
    for_graph = open("data.csv",'a')
    for_graph.write(for_graph_log)
    for_graph.close()
    
    print("Total pikachu : \t", pikachu)
